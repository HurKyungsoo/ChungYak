...
class EligibilityEngineTest {
    ...
    @Test
    @DisplayName("신혼부부 - 혼인 7년 이내 + 무주택 + 통장 6개월이면 자격 있음")
    ...
    void newlywedMarriageBoundary() {
        ApplicantProfile at84 = ApplicantProfile.builder()
                .married(true).monthsSinceMarriage(84)
                .houseless(true).accountMonths(12).build();
        ApplicantProfile at85 = ApplicantProfile.builder()
